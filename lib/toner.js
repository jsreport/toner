...
var toner = module.exports = {
};

exports = toner;

toner.init = function(options) {
    ...
    this.scriptManager = require("script-manager")();
...
toner.engine = function(name, pathToEngine) {
...
toner.renderEngine = function(req, res, cb) {
    var self = this;
...
toner.after = function(fn) {
    this._afterRender.push(fn);
};

toner.before = function(fn) {
    this._beforeRender.push(fn);
};

toner.afterEngine = function(fn) {
    this._afterEngine.push(fn);
};

toner.render = function(req, cb) {
    var res = { headers : {}};
    req.toner = this;
